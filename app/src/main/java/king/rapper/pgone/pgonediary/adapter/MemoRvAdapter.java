...
public class MemoRvAdapter extends RecyclerSwipeAdapter<MemoRvAdapter.SimpleViewHolder> {
    ...
    private List<MemoInfo> mDataset;

    public MemoRvAdapter(Context context, List<MemoInfo> objects) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rv_memo, parent, false);
        return new SimpleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final SimpleViewHolder viewHolder, final int position) {
        MemoInfo memoInfo = mDataset.get(position);
    ...
    public void setList(List<MemoInfo> list) {
        this.mDataset = list;
